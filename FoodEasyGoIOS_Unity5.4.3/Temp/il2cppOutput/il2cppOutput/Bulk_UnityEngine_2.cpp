...
extern "C"  void WWWForm_AddField_m355604532 (WWWForm_t461342257 * __this, String_t* ___fieldName0, int32_t ___i1, const MethodInfo* method)
{
	{
		String_t* L_0 = ___fieldName0;
		String_t* L_1 = Int32_ToString_m1286526384((&___i1), /*hidden argument*/NULL);
...
IL_0019:
		{
			...
			NullCheck(L_7);
			VirtActionInvoker1< uint8_t >::Invoke(19 /* System.Void System.IO.MemoryStream::WriteByte(System.Byte) */, L_7, ((int32_t)32));
			goto IL_005d;
		}
...
IL_003a:
		{
			...
			NullCheck(L_16);
			VirtActionInvoker1< uint8_t >::Invoke(19 /* System.Void System.IO.MemoryStream::WriteByte(System.Byte) */, L_16, L_20);
			goto IL_005d;
		}
...
IL_0054:
		{
			...
			NullCheck(L_21);
			VirtActionInvoker1< uint8_t >::Invoke(19 /* System.Void System.IO.MemoryStream::WriteByte(System.Byte) */, L_21, L_25);
		}
...
IL_006a:
		{
			...
			NullCheck(L_29);
			ByteU5BU5D_t4260760469* L_30 = VirtFuncInvoker0< ByteU5BU5D_t4260760469* >::Invoke(25 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_29);
			V_2 = L_30;
