...
{
	{
		...
		UnityAction_2_t2640361832 * L_1 = ___action0;
		Delegate_t3310234105 * L_2 = Delegate_Combine_m1842362874(NULL /*static, unused*/, (Delegate_t3310234105 *)L_0, (Delegate_t3310234105 *)L_1, /*hidden argument*/NULL);
		__this->set_Delegate_0(((UnityAction_2_t2640361832 *)Castclass(L_2, IL2CPP_RGCTX_DATA(method->declaring_type->rgctx_data, 1))));
		return;
	}
}
