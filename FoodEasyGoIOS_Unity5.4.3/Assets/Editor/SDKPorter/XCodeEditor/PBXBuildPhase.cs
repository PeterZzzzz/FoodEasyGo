...
//			DebugLogger.Log( "base" );
		...
		{
//			DebugLogger.Log( "constructor " + GetType().Name );
		}
...
//				return false;
//			DebugLogger.Log( "--> buildphase " + (string)_data[ ISA_KEY ] );
			
			
			if( !ContainsKey( FILES_KEY ) ){
//				DebugLogger.Log( "key not present" );
				this.Add( FILES_KEY, new PBXList() );
			}
//			DebugLogger.Log( "key: " + _data[ FILES_KEY ] );
//			DebugLogger.Log( "Adding: " + file.guid );
			((PBXList)_data[ FILES_KEY ]).Add( file.guid );
//			if( ((PBXList)_data[ FILES_KEY ]).Contains( file.guid ) ) {
//				DebugLogger.Log( "AGGIUNTO" );
//			}
//			else {
//				DebugLogger.Log( "MANCA" );
//			}
...
//        return id in self['files']
	...
	public class PBXFrameworksBuildPhase : PBXBuildPhase
	{
		...
		{
//			DebugLogger.Log( "constructor child" + GetType().Name );
		}
	}
