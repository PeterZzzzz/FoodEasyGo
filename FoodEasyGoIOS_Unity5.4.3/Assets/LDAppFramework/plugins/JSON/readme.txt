...
void accessData(JSONObject obj){
	switch(obj.type){
		...
		case JSONObject.Type.STRING:
			DebugLogger.Log(obj.str);
			break;
		case JSONObject.Type.NUMBER:
			DebugLogger.Log(obj.n);
			break;
		case JSONObject.Type.BOOL:
			DebugLogger.Log(obj.b);
			break;
...
DebugLogger.Log(arr[2].n);		//Should ouptut "3"
</syntaxhighlight>
