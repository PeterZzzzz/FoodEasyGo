...
public class UniShare: MonoBehaviour  {
	...
	void ShareNativeImage(string shareText) {
		...
		DebugLogger.Log("UNISHARE: " + "started");

		string screenShotPath = Application.persistentDataPath + "/" + ScreenshotName;

		//DebugLogger.Log("UNISHARE: " + System.IO.File.Exists(screenShotPath));
		//DebugLogger.Log("UNISHARE: " + screenShotPath);
		...
		DebugLogger.Log("UNISHARE: " + "file://" + screenShotPath);
