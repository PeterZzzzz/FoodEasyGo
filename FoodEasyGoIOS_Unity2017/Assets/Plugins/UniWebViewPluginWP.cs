...
public class UniWebViewPlugin {
    ...
    public static void GoBack(string name) {
        if (Application.platform == RuntimePlatform.WP8Player)
        {
            DebugLogger.Log("Calling go back of native");
            Setup();
    ...
    public static void SetBounces(string name, bool enable) {
        if (Application.platform == RuntimePlatform.WP8Player)
        {
            ...
            DebugLogger.Log("SetBounces is not implemented in WP8. You cannot control the zoom in native way. Please use viewport tag in your html header.");
        }
    }
    ...
    public static void SetZoomEnable(string name, bool enable) {
        if (Application.platform == RuntimePlatform.WP8Player)
        {
            ...
            DebugLogger.Log("SetZoomEnable is not implemented in WP8. You cannot control the zoom in native way. Please use viewport tag in your html header.");
        }
    }
    ...
    public static void SetUseWideViewPort(string name, bool use) {
        if (Application.platform == RuntimePlatform.WP8Player)
        {
            ...
            DebugLogger.Log("SetUseWideViewPort is not implemented in WP8. viewport tag support is always on for WP8.");
        }
    }
