...
public class FindMissingScripts : EditorWindow 
{
	...
	static void FindInAll()
	{
		...
		{
			//DebugLogger.Log(root);
			FindInGO(root);
		}
		DebugLogger.Log(string.Format("Searched {0} GameObjects, {1} components, found {2} missing", go_count, components_count, missing_count));
	}
	...
	static void FindInGO(GameObject g)
	{
		...
		{
			//DebugLogger.Log("Searching " + childT.name  + " " );
