...
public class BlurBehind : MonoBehaviour
{
    ...
    bool CheckResources()
    {
        if (blurMaterial == null)
        {
            if (blurShader != null)
            {
                ...
                {
                    DebugLogger.Log("Blur Behind UI: Shader not supported");
                    return false;
                }
            }
            else
            {
                DebugLogger.Log("Blur Behind UI: Shader reference missing");
                return false;
            }
        }
        return true;
    ...
    bool CheckSupport()
    {
        ...
        {
            DebugLogger.Log("Blur Behind UI: Image effects not supported");
            return false;
        }
        if (!SystemInfo.supportsRenderTextures)
        {
            DebugLogger.Log("Blur Behind UI: Render textures not supported");
            return false;
        }
        return true;
    }
