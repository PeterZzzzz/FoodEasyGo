...
class OrderController extends BaseController {
	...
	private function createInitNotification($restaurant_info, $sub_order_info)
    {
        ...
        $res3=M('restaurant_notification')->add(array("restaurant_id"=>$restaurant_info['id'], "ios_token"=>$restaurant_info['ios_token'], "sub_order_number"=>$sub_order_info['order_number'], "title"=>"3分钟未确认/3 min order not confirmed", "body"=>"你的订单".$sub_order_info['order_number']."已经下单3分钟，尚未确认，请尽快确认，如有问题，请联系FoodEasyGo客服/Your order ".$sub_order_info['order_number']." has been unconfirmed for more than 3 minutes, please confirm order ASAP, or contact us if there's a prlblem", "status"=>0, "create_time"=>time(), "target_send_time"=>(time()+180)));
        $res5= M('restaurant_notification')->add(array("restaurant_id"=>$restaurant_info['id'], "ios_token"=>$restaurant_info['ios_token'], "sub_order_number"=>$sub_order_info['order_number'], "title"=>"5分钟未确认/5 min order not confirmed", "body"=>"你的订单".$sub_order_info['order_number']."已经下单了5分钟，请尽快送达，如有问题，请联系FoodEasyGo客服/Your order ".$sub_order_info['order_number']." has been under unconfirmed for more than 5 minutes, please confirm ASAP, or contact us if there's a prlblem", "status"=>0, "create_time"=>time(), "target_send_time"=>(time()+300)));
